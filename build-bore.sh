...
cd ./linux-xanmod-bore ; su builder -c "yes '' | MAKEFLAGS=\"-j $(nproc)\" env _microarchitecture=93 _compress_modules=y _use_numa=y _use_tracers=n _use_O3=y _compiler='clang' makepkg --noconfirm -sc"
